...
it('should handle ascending order', () => {
  const funds = [{ score: 4 }, { score: 3 }, { score: 2 }, { score: 5 }, { score: 1 }];

  const orderedFunds = [{ score: 1 }, { score: 2 }, { score: 3 }, { score: 4 }, { score: 5 }];
...
it('should handle descending order', () => {
  ...
  const orderedFunds = [{ score: 5 }, { score: 4 }, { score: 3 }, { score: 2 }, { score: 1 }];
